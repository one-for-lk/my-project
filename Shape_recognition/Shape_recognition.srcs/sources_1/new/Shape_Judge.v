...
(
    ...
    assign sanjiao = ((MIDDLES < subtract12 <= BIG) && (MIDDLES < subtract23 <= BIG)&&(!concrast12) && (!concrast23)) ? TURE : !TURE;//1 : 0
    assign yuan = ((SMALL2 < subtract12 <= MIDDLEY) && (SMALL2 < subtract23 <= MIDDLEY) &&(!concrast12) && (concrast23)) ? TURE : !TURE;//1 : 0
